      ...
      <div className="flex flex-col">
        <div className="flex py-6">
          <table className="w-1/2 m-4 border border-black border-collapse">
            ...
            <tbody>
              <tr className="w-[100%]">
                <td className="w-[30%] border p-1 font-bold">Merchant ID</td>
                <td className="w-[70%] border p-1 font-bold">
                  {sellerInfo.merchantId}
                </td>
              </tr>
              <tr className="w-[100%]">
                <td className="w-[30%] border p-1 font-bold">Merchant Name</td>
                <td className="w-[70%] border p-1 font-bold">
              ...
              <tr>
                <td className="border p-1 font-bold">Card Number</td>
                <td className="border p-1 font-bold">
              ...
              <tr>
                ...
                <td className="border p-1 font-bold">{sellerInfo.gstNumber}</td>
              </tr>
              <tr>
                <td className="border p-1 font-bold">Company PAN</td>
                <td className="border p-1 font-bold">
                  {sellerInfo.companyPan}
                </td>
              </tr>
              <tr>
                <td className="border p-1 font-bold">Status</td>
                <td className="border p-1 font-bold">
                  {sellerInfo.profileStatus}
                </td>
              </tr>
              {/* <tr>
