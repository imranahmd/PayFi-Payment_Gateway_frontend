...
const SellerSettlementBetDate = ({ data }) => {
  console.log(data)
  const pdfRef = useRef();
  ...
  return (
    <div className="p-4 yearly-report">
      <h2 className="text-xl font-bold mb-4">Settlement Transactions Between Selected Dates</h2>
...
export default SellerSettlementBetDate;
