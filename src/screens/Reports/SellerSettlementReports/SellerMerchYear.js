...
const SellerMerchYear = ({ data }) => {
    console.log("seller Merch Year",data)
  const pdfRef = useRef();
  ...
  return (
    <div className="p-4 yearly-report">
      <h2 className="text-xl font-bold mb-4">Year Wise Settlement Transaction History</h2>
      ...
      <table id="data-table" className="table-auto border-collapse border border-black my-4">
        ...
        <thead>
          <tr>
          <th className="border border-black px-4 py-2">merchant Id</th>
...
export default SellerMerchYear;
